...
public class MainActivity extends AppCompatActivity {
    ...
    private void parseJSON() {
        String url = "http://192.168.1.9:5001/api/Etudiant";
                    ...
                    public void onResponse(JSONArray  response) {
                        try {
                            ...
                            for (int i = 0; i < jsonArray.length(); i++) {
                                ...
                                String nom = hit.getString("lastName");
                                String prenom = hit.getString("firstMidName");
                                String cne = hit.getString("enrollmentDate");
